      ...
      <van-popup v-model="show"
        ...
        <div style="height:254px;width:100%;overflow-y: scroll;">
          <van-collapse v-model="activeName"
                        accordion>
            <div class="menu-box"
                 @click="changeTitle('新闻','/news')">新闻</div>
            <div class="menu-box"
                 @click="changeTitle('地图','/map')">地图</div>
            <van-collapse-item title="历史"
                               name="1">
              <div class="menu-box"
                   @click="changeTitle('大事件','/bigevent')">大事件</div>
              <div class="menu-box"
                   @click="changeTitle('车辆年表','/vehiclechronology')">车辆年表</div>
            </van-collapse-item>
            <van-collapse-item title="游戏道具"
                               name="2">
              <div class="menu-box"
                   @click="changeTitle('车辆','/vehicle')">车辆</div>
              <div class="menu-box"
                   @click="changeTitle('人物','/role')">人物</div>
            </van-collapse-item>
          </van-collapse>
        </div>
      </van-popup>
